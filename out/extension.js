...
function activate(context) {
    const disposable = vscode.commands.registerCommand('ai.openWebview', () => {
        const panel = vscode.window.createWebviewPanel('aiPanel', 'AI Assistant', vscode.ViewColumn.One, {
            enableScripts: true,
            localResourceRoots: [
